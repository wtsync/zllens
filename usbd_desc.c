...
#define USBD_MFC_STRING                 "VoCore"
#define USBD_PRODUCT_STRING             "VoCore ZhiLin Lens"
#define USBD_CONFIGURATION_STRING       "VoCore ZhiLin Lens Config"
#define USBD_INTERFACE_STRING           "VoCore ZhiLin Lens Interface"
